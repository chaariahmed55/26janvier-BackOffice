...
$(function () {
  ...
  // DataTable
  var individualColumnTextSearching = $(
    ".individual-column-searching-text-datatable"
  ).DataTable({
    scrollX: true,
    scrollCollapse: true,
  });
    ...
    initComplete: function () {
      this.api()
        ...
        .every(function () {
          var column = this;
          var select = $(
            '<select class="form-control"><option value=""></option>' +
              "</select>"
          )
  ...
  $("#countRow").click(function () {
    alert(
      rowSelectionTable.rows(".selected").data().length + " row(s) selected"
    );
  });
