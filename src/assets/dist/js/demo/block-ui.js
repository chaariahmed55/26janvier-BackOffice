...
$(function () {
  ...
  $(".blockui-msg-animation").on("click", function () {
    ...
    $(ele).block({
      message:
        '<div class="font-16"><div class="icon-refresh spinner mr-2 d-inline-block"></div>Loading ...</div>',
      fadeIn: 1000,
      fadeOut: 1000,
      timeout: 2000,
      overlayCSS: {
  ...
  $(".blockui-multiple-msgs").on("click", function () {
    ...
    window.setTimeout(function () {
      message.html(
        '<div class="font-16"><span class="icon-thumbs-o-up mr-2"></span>Job Well Done</div>'
      );
    }, 4000);
