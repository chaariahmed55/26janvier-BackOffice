  ...
  if (!D && E)
    if ("function" == typeof __webpack_require__)
      ...
      if (void 0 !== require.resolve)
        ...
        void 0 !== require.specified && (D = require.specified("codemirror"));
  var F =
  ...
  var Pt = (function () {
      ...
      return (
        (e.prototype.nativeRange = function () {
          ...
          return (
            e.setEndPoint("EndToEnd", Lt({ node: this.ec, offset: this.eo })), e
          );
        }),
        ...
        (e.prototype.wrapBodyInlineWithPara = function () {
          ...
          if (Nt.isInline(t.sc)) {
            ...
            (o = N.last(n)),
              Nt.isInline(o) || (o = n[n.length - 2] || t.sc.childNodes[t.so]);
          } else o = t.sc.childNodes[t.so > 0 ? t.so - 1 : 0];
          var i = Nt.listPrev(o, Nt.isParaInline).reverse();
          if (
            (i = i.concat(Nt.listNext(o.nextSibling, Nt.isParaInline))).length
          ) {
      ...
      return (
        (e.prototype.representShortcut = function (t) {
          ...
          return this.options.shortcuts && e
            ? (B.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
              " (" +
                (e = e
                  .replace("BACKSLASH", "\\")
                  .replace("SLASH", "/")
      ...
      return (
        ...
        (e.prototype.initialize = function () {
          ...
          this.context.invoke("buttons.build", t, this.options.popover.table),
            B.isFF && document.execCommand("enableInlineTableEditing", !1, !1);
        }),
        (e.prototype.destroy = function () {
          this.$popover.remove();
        }),
  ...
  t.fn.extend({
    summernote: function () {
      ...
      (i.langInfo = t.extend(
        ...
        (i.tooltip = "auto" === i.tooltip ? !B.isSupportTouch : i.tooltip),
