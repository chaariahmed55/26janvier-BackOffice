...
define(function (require) {
  ...
  DataRange.prototype = {
    ...
    _buildItem: function () {
      ...
      if (
        this.dataRangeOption.orient == "vertical" &&
      ...
      this._indicatorShape = {
        style: {
          ...
          __rect: {
            ...
            height:
              size * (this.dataRangeOption.orient == "horizontal" ? 1 : 2),
          },
        },
        highlightStyle: {
          brushType: "fill",
    ...
    _getTextShape: function (x, y, text) {
      return {
        ...
        style: {
          x:
            this.dataRangeOption.orient == "horizontal"
              ? x
          ...
          textBaseline:
            this.dataRangeOption.orient == "horizontal" ? "middle" : "top",
          textAlign:
            this.dataRangeOption.orient == "horizontal" ? "left" : "center",
        },
        hoverable: false,
      };
    },
    ...
    _buildSplitList: function () {
      ...
      for (var i = 0, len = splitList.length; i < len; i++) {
        ...
        if (
          !splitListItem ||
          (splitListItem.start == null && splitListItem.end == null)
        ) {
