...
define("echarts/echarts", [
  ...
  function callChartListMethodReverse(
    ecInstance,
    methodName,
    arg0,
    arg1,
  ...
  Echarts.prototype = {
    _init: function () {
      ...
      this._zr = _zr;
      this._messageCenter.dispatch = function (
        type,
        event,
        eventPackage,
        that
      ...
      for (var i = 0, l = series.length; i < l; i++) {
        if (
          ...
          (series[i].markPoint &&
            ...
            series[i].markPoint.data.length > 0) ||
          (series[i].markLine &&
            series[i].markLine.data &&
            series[i].markLine.data.length > 0) ||
      ...
      while (len--) {
        ...
        if (magicOption[mergeItem] == null) {
          magicOption[mergeItem] =
            this._themeConfig[mergeItem] != null
        ...
        if (seriesItem) {
          ...
          if (additionData != null) {
            ...
            if (
              ...
              if (
                optionRestore.xAxis[axisIdx].type == null ||
          ...
          this._option.series[seriesIdx].data =
            magicOption.series[seriesIdx].data;
        }
      }
      this._zr.clearAnimation();
...
define("zrender/zrender", [
  ...
  var ZRender = function (id, dom) {
    ...
    this.animation = new Animation({
      stage: { update: getFrameCallback(this) },
    });
...
define("echarts/component/toolbox", [
  ...
  Toolbox.prototype = {
    ...
    _buildShape: function () {
      ...
      if (iconName.length > 0) {
        ...
        for (var i = 0, l = iconName.length; i < l; i++) {
          ...
          this._featureTitle[name] =
            feature[key].title[name] || feature[key].title;
          if (feature[key].icon) {
            this._featureIcon[name] =
              feature[key].icon[name] || feature[key].icon;
          }
          if (feature[key].color) {
            this._featureColor[name] =
              feature[key].color[name] || feature[key].color;
          }
          if (feature[key].option) {
            this._featureOption[name] =
              feature[key].option[name] || feature[key].option;
          }
        }
    ...
    _buildItem: function () {
      ...
      var itemShape;
      var color =
        toolboxOption.color instanceof Array
          ? toolboxOption.color
          : [toolboxOption.color];
      ...
      for (var i = 0; i < iconLength; i++) {
        itemShape = {
          ...
          style: {
            ...
            lineWidth: 1,
            strokeColor:
              this._featureColor[this._iconList[i]] || color[i % color.length],
            brushType: "stroke",
          },
          highlightStyle: {
            lineWidth: 1,
        ...
        if (toolboxOption.orient === "horizontal") {
          if (i === 0 && textAlign === "left") {
            ...
            itemShape.highlightStyle.textY =
              textBaseline === "top" ? lastY + itemSize + 10 : lastY - 10;
          }
    ...
    reset: function (newOption, isRestore) {
      ...
      if (
        this.query(newOption, "toolbox.show") &&
        ...
        while (len--) {
          ...
          if (this._magicMap[oriType]) {
            ...
            if (axis && (axis.type || "category") === "category") {
              axis.__boundaryGap =
                axis.boundaryGap != null ? axis.boundaryGap : true;
            }
            axis =
          ...
          if (
            this._magicMap[_MAGICTYPE_STACK] ||
      ...
      if (zoomOption && zoomOption.show) {
        var start =
          zoomOption.start != null &&
          zoomOption.start >= 0 &&
          zoomOption.start <= 100
            ? zoomOption.start
            : 0;
        var end =
          zoomOption.end != null && zoomOption.end >= 0 && zoomOption.end <= 100
            ? zoomOption.end
            : 100;
        if (start > end) {
          start = start + end;
    ...
    getMagicOption: function () {
      ...
      var chartType;
      if (
        this._magicType[ecConfig.CHART_TYPE_LINE] ||
        ...
        for (var i = 0, l = this.option.series.length; i < l; i++) {
          ...
          if (
            chartType == ecConfig.CHART_TYPE_LINE ||
      ...
      if (
        this._magicType[_MAGICTYPE_STACK] ||
      ...
      if (this._magicType[cType1] || this._magicType[cType2]) {
        for (var i = 0, l = this.option.series.length; i < l; i++) {
          ...
          if (chartType == cType1 || chartType == cType2) {
            this.option.series[i].type = this._magicType[cType1]
              ? cType1
              : cType2;
  ...
  Title.prototype = {
    ...
    _getItemGroupLocation: function () {
      ...
      var totalHeight =
        ...
        (subtext === ""
          ? 0
          : this.titleOption.itemGap + zrArea.getTextHeight(subtext, subfont));
      var x;
      var zrWidth = this.zr.getWidth();
      switch (this.titleOption.x) {
        case "center":
      ...
      switch (this.titleOption.y) {
        ...
        case "bottom":
          y =
            zrHeight - totalHeight - padding[2] - this.titleOption.borderWidth;
          break;
        case "center":
          y = Math.floor((zrHeight - totalHeight) / 2);
          break;
...
define("echarts/component/tooltip", [
  ...
  Tooltip.prototype = {
    ...
    showTip: function (params) {
      ...
      var isAxisTrigger =
        this.deepQuery([serie, this.option], "tooltip.trigger") === "axis";
      if (!chart) {
        return;
      }
      if (isAxisTrigger) {
            ...
            for (var i = 0, l = shapeList.length; i < l; i++) {
              if (
                ...
                var midAngle =
                  (((style.startAngle + style.endAngle) / 2) * Math.PI) / 180;
                x =
                  this._curTarget.style.x + Math.cos(midAngle) * (style.r - 2);
                y =
                  this._curTarget.style.y - Math.sin(midAngle) * (style.r - 2);
...
define("echarts/component/legend", [
  ...
  Legend.prototype = {
    ...
    _buildItem: function () {
      ...
      var color;
      if (
        this.legendOption.orient === "vertical" &&
        this.legendOption.x === "right"
      ) {
        lastX =
          this._itemGroupLocation.x + this._itemGroupLocation.width - itemWidth;
      }
      for (var i = 0; i < dataLength; i++) {
        ...
        if (this.legendOption.selectedMode) {
          ...
          itemShape.onmouseover = textShape.onmouseover =
      ...
      if (this.legendOption.orient === "horizontal") {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          var tempTextWidth = zrArea.getTextWidth(
            ...
            data[i].textStyle
              ? this.getFont(zrUtil.merge(data[i].textStyle || {}, textStyle))
              : font
          );
      ...
      if (newOption) {
        ...
        if (this.legendOption.selected) {
          for (var k in this.legendOption.selected) {
            this._selectedMap[k] =
              typeof this._selectedMap[k] != "undefined"
                ? this._selectedMap[k]
...
define("zrender/tool/color", ["require", "../tool/util"], function (require) {
  ...
  function getStepColors(start, end, step) {
    ...
    for (
      var i = 0, r = start[0], g = start[1], b = start[2], a = start[3];
      i < step;
      i++
    ) {
      colors[i] = toColor(
...
define("echarts/component/timeline", [
  ...
  Timeline.prototype = {
    ...
    _getReformedLabel: function (idx) {
      var timelineOption = this.timelineOption;
      var data =
        timelineOption.data[idx].name != null
          ? timelineOption.data[idx].name
          : timelineOption.data[idx];
      var formatter =
        timelineOption.data[idx].formatter || timelineOption.label.formatter;
      if (formatter) {
        if (typeof formatter === "function") {
    ...
    _getChainPoint: function () {
      ...
      if (len > 1) {
        ...
        boundaryGap =
          boundaryGap > 50 ? 50 : boundaryGap < 20 ? 5 : boundaryGap;
        width -= boundaryGap * 2;
        if (timelineOption.type === "number") {
          ...
          xList[len - 1] =
            new Date(_getName(len - 1).replace(/-/g, "/")) - xList[0];
          for (var i = 1; i < len; i++) {
            xList[i] =
              x +
              boundaryGap +
              (width * (new Date(_getName(i).replace(/-/g, "/")) - xList[0])) /
                xList[len - 1];
          }
    ...
    _findChainIndex: function (x) {
      ...
      for (var i = 0; i < len - 1; i++) {
        if (x >= chainPoint[i].x && x <= chainPoint[i + 1].x) {
          return Math.abs(x - chainPoint[i].x) <
            Math.abs(x - chainPoint[i + 1].x)
            ? i
            : i + 1;
        }
      }
    ...
    __ondrift: function (shape, dx) {
      ...
      if (shape.style.x + dx <= chainPoint[0].x - chainPoint[0].symbolSize) {
        ...
        shape.style.x + dx >=
        chainPoint[len - 1].x - chainPoint[len - 1].symbolSize
      ) {
    ...
    play: function (targetIndex, autoPlay) {
      ...
      this.currentIndex =
        targetIndex != null ? targetIndex : this.currentIndex + 1;
      if (this.currentIndex >= this.timelineOption.data.length) {
        this.currentIndex = 0;
      }
      this._onFrame();
    ...
    setTheme: function (needRefresh) {
      this.timelineOption = this.reformOption(
        zrUtil.clone(this.option.timeline)
      );
...
define("zrender/loadingEffect/DynamicLine", [
  ...
  DynamicLine.prototype._start = function (addShapeHandle, refreshHandle) {
    ...
    for (var i = 0; i < n; i++) {
      ...
      var color =
        effectOption.color == "random" ? zrColor.random() : effectOption.color;
...
define("zrender/loadingEffect/Ring", [
  ...
  Ring.prototype._start = function (addShapeHandle, refreshHandle) {
    ...
    if (options.progress != null) {
      ...
      for (var i = 0; i < 20; i++) {
        shapeList[i].highlightStyle.color =
          i < n ? shapeList[i]._color : darkColor;
        addShapeHandle(shapeList[i]);
      }
      addShapeHandle(textShape);
      refreshHandle();
...
define("zrender/loadingEffect/Spin", [
  ...
  Spin.prototype._start = function (addShapeHandle, refreshHandle) {
    ...
    var textWidth = zrArea.getTextWidth(
      textShape.highlightStyle.text,
      textShape.highlightStyle.textFont
    );
    ...
    effectOption.y = textShape.highlightStyle.y =
...
define("zrender/Handler", [
  ...
  Handler.prototype._dispatchAgency = function (
    targetShape,
    eventName,
    event,
    draggedShape
  ...
  Handler.prototype._zrenderEventFixed = function (event, isTouch) {
    ...
    if (!isTouch) {
      ...
      if (target && target != this._domHover) {
        event.zrenderX =
          (typeof event.offsetX != "undefined" ? event.offsetX : event.layerX) +
          target.offsetLeft;
        event.zrenderY =
          (typeof event.offsetY != "undefined" ? event.offsetY : event.layerY) +
          target.offsetTop;
      }
    } else {
      var touch =
...
define("zrender/tool/area", ["require", "./util", "./curve"], function (
  require
) {
  "use strict";
...
define("zrender/shape/Base", [
  ...
  Base.prototype.getHighlightStyle = function (
    style,
    highlightStyle,
    brushTypeOnly
  ) {
    ...
    if (style.brushType != "stroke") {
      ...
      if (brushTypeOnly != "stroke") {
        ...
        newStyle.strokeColor =
          ...
          color.mix(style.strokeColor, color.toRGB(highlightColor));
      }
    }
  ...
  Base.prototype.drawText = function (ctx, style, normalStyle) {
    ...
    switch (textPosition) {
      ...
      case "right":
        if (this.getRect) {
          var rect =
            (normalStyle || style).__rect || this.getRect(normalStyle || style);
          switch (textPosition) {
            case "inside":
      ...
      case "end":
        ...
        ty = yEnd;
        var angle =
          (Math.atan((yStart - yEnd) / (xEnd - xStart)) / Math.PI) * 180;
        if (xEnd - xStart < 0) {
          angle += 180;
    ...
    updateTransform: function () {
      ...
      if (this.needLocalTransform) {
        ...
        if (isNotAroundZero(scale[0]) || isNotAroundZero(scale[1])) {
          ...
          origin[1] = -scale[3] || 0;
          var haveOrigin =
            isNotAroundZero(origin[0]) || isNotAroundZero(origin[1]);
          if (haveOrigin) {
...
define("zrender/animation/Clip", ["require", "./easing"], function (require) {
  ...
  Clip.prototype = {
    step: function (time) {
      ...
      var easingFunc =
        typeof this.easing == "string" ? Easing[this.easing] : this.easing;
      var schedule =
...
define("echarts/chart/base", [
  ...
  function Base(ecTheme, messageCenter, zr, option, myChart) {
    ...
    this.shapeHandler = {
      ...
      ondragover: function (param) {
        ...
        highlightStyle.strokeColor =
          self.ecTheme.calculableColor || ecConfig.calculableColor;
  ...
  Base.prototype = {
    setCalculable: function (shape) {
      shape.dragEnableTime =
        this.ecTheme.DRAG_ENABLE_TIME || ecConfig.DRAG_ENABLE_TIME;
      ...
      if (dataIndex === -1) {
        ...
        if (data.value != null) {
          if (data.value != "-") {
            ...
            series[seriesIndex].data[dataIndex].value = ecData.get(
              dragged,
              "value"
            );
          }
          if (
            this.type === ecConfig.CHART_TYPE_FUNNEL ||
            this.type === ecConfig.CHART_TYPE_PIE
          ) {
            legend &&
              legend.getRelatedAmount(data.name) === 1 &&
              this.component.legend.del(data.name);
            data.name +=
              this.option.nameConnector + ecData.get(dragged, "name");
            legend &&
              legend.add(
                data.name,
                dragged.style.color || dragged.style.strokeColor
      ...
      for (var i = 0, l = series.length; i < l; i++) {
        if (series[i].type === this.type) {
          ...
          this.legendHoverLink =
            series[i].legendHoverLink || this.legendHoverLink;
    ...
    _mapData: function (seriesArray) {
      ...
      for (var i = 0, l = seriesArray.length; i < l; i++) {
        ...
        if (legend) {
          ...
          this._sIndex2ColorMap[seriesArray[i]] = this.zr.getColor(
            seriesArray[i]
          );
        }
    ...
    _buildMarkPoint: function (seriesIndex) {
      ...
      if (
        this.type === ecConfig.CHART_TYPE_FORCE ||
    ...
    _buildMarkLine: function (seriesIndex) {
      ...
      if (isLarge) {
        ...
        if (firstShape) {
          ...
          zrUtil.merge(
            (shapeBundle.highlightStyle = {}),
            firstShape.highlightStyle
          );
      ...
      if (!mpOption.large) {
        for (var i = 0, l = data.length; i < l; i++) {
          ...
          if (dataRange) {
            ...
            nColor =
              this.deepQuery(queryTarget, "itemStyle.normal.color") || color;
            eColor =
              this.deepQuery(queryTarget, "itemStyle.emphasis.color") || nColor;
    ...
    _markLine: (function () {
      ...
      return function (seriesIndex, mlOption) {
        ...
        var defaultColor = legend
          ? legend.getColor(serie.name)
        ...
        if (enableBundling) {
          ...
          edgeBundling.maxTurningAngle =
            (this.query(mlOption, "bundling.maxTurningAngle") / 180) * Math.PI;
    ...
    getSymbolShape: function (
      ...
      symbolSize =
        typeof symbolSize === "function" ? symbolSize(value) : symbolSize;
      ...
      var eColor = this.getItemStyleColor(
        emphasis.color,
        seriesIndex,
        dataIndex,
        data
    ...
    getMarkLineShape: function (
      ...
      symbolSize[0] =
        typeof symbolSize[0] === "function"
          ? symbolSize[0](value0)
          : symbolSize[0];
      symbolSize[1] =
        typeof symbolSize[1] === "function"
          ? symbolSize[1](value1)
          : symbolSize[1];
      var symbolRotate = [
      ...
      var normal = this.deepMerge(queryTarget, "itemStyle.normal");
      normal.color = this.getItemStyleColor(
        normal.color,
        seriesIndex,
        dataIndex,
        data
      ...
      var emphasis = this.deepMerge(queryTarget, "itemStyle.emphasis");
      emphasis.color = this.getItemStyleColor(
        emphasis.color,
        seriesIndex,
        dataIndex,
        data
      ...
      var itemShape = new ShapeCtor({
        style: {
          ...
          strokeColor:
            nlineStyle.color || normal.borderColor || normal.color || color,
          lineWidth: nBorderWidth,
    ...
    getLargeMarkPointShape: function (seriesIndex, mpOption) {
      ...
      itemShape = new SymbolShape({
        style: {
          ...
          shadowBlur:
            (effect.shadowBlur != null ? effect.shadowBlur : 8) *
            devicePixelRatio,
      ...
      if (
        ...
        for (key in newMap) {
          if (oldMap[key]) {
            ...
            delay =
              (this.type == ecConfig.CHART_TYPE_LINE ||
    ...
    animationEffect: function (shapeList) {
      ...
      if (this.canvasSupported) {
        this.zr.modLayer(zlevel, {
          motionBlur: true,
          lastFrameAlpha:
            this.option.effectBlendAlpha || ecConfig.effectBlendAlpha,
        });
      }
      var shape;
      for (var i = 0, l = shapeList.length; i < l; i++) {
    ...
    clearEffectShape: function (clearMotionBlur) {
      ...
      if (this.zr && effectList && effectList.length > 0) {
        clearMotionBlur &&
          this.zr.modLayer(ecConfig.EFFECT_ZLEVEL, { motionBlur: false });
      ...
      if (this.selectedMap[serie.name]) {
        ...
        if (this.option.animation && !this.option.renderAsImage) {
          this.animationMark(
            duration,
            easing,
            this.shapeList.slice(lastLength)
          );
        } else {
...
define("zrender/shape/Circle", ["require", "./Base", "../tool/util"], function (
  require
) {
  "use strict";
  var Base = require("./Base");
...
define("echarts/util/accMath", [], function () {
  function accDiv(arg1, arg2) {
    ...
    return (
      ((s1.replace(".", "") - 0) / (s2.replace(".", "") - 0)) * Math.pow(10, m)
    );
  }
...
define("echarts/util/shape/Icon", [
  ...
  Icon.prototype = {
    ...
    brush: function (ctx, isHighlight, refreshNextFrame) {
      ...
      if (iconType === "image") {
        var ImageShape = require("zrender/shape/Image");
        ImageShape.prototype.brush.call(
          this,
          ctx,
          isHighlight,
          refreshNextFrame
    ...
    buildPath: function (ctx, style, refreshNextFrame) {
      if (this.iconLibrary[style.iconType]) {
        this.iconLibrary[style.iconType].call(
          this,
          ctx,
          style,
          refreshNextFrame
    ...
    getRect: function (style) {
      ...
      style.__rect = {
        ...
        y: Math.round(
          style.y - (style.iconType == "pin" ? (style.height / 2) * 1.5 : 0)
        ),
        width: style.width,
...
define("echarts/util/shape/MarkLine", [
  ...
  MarkLine.prototype = {
    ...
    buildPath: function (ctx, style) {
      ...
      if (style.curveness > 0) {
        ...
        if (lineType == "solid") {
          ...
          var dashLength =
            (style.lineWidth || 1) * (style.lineType == "dashed" ? 5 : 1);
          dashedLineTo(
            ctx,
            style.xStart,
            style.yStart,
    ...
    brushSymbol: function (ctx, style, idx) {
      ...
      var curveness = style.curveness || 0;
      var rotate =
        style.symbolRotate[idx] != null ? style.symbolRotate[idx] - 0 : 0;
...
define("echarts/util/ecAnimation", [
  ...
  function pointList(zr, oldShape, newShape, duration, easing) {
    ...
    if (!oldShape) {
      ...
      if (newShape.type == "half-smooth-polygon") {
        oldPointList[newPointListLen - 1] = zrUtil.clone(
          newPointList[newPointListLen - 1]
        );
        oldPointList[newPointListLen - 2] = zrUtil.clone(
          newPointList[newPointListLen - 2]
        );
      }
    ...
    if (oldPointListLen == newPointListLen) {
      ...
      newShape.style.pointList = oldPointList.concat(
        newPointList.slice(oldPointListLen)
      );
    } else {
  ...
  function rectangle(zr, oldShape, newShape, duration, easing) {
    ...
    zr.addShape(newShape);
    if (
      newPosition[0] != oldShape.position[0] ||
      newPosition[1] != oldShape.position[1]
    ) {
  ...
  function polygon(zr, oldShape, newShape, duration, easing) {
    var rect = require("zrender/shape/Polygon").prototype.getRect(
      newShape.style
    );
...
define("echarts/util/ecEffect", [
  ...
  function point(zr, effectList, shape, zlevel) {
    ...
    var shadowBlur =
      typeof effect.shadowBlur != "undefined" ? effect.shadowBlur : size;
    var effectShape;
    if (shape.type !== "image") {
      effectShape = new IconShape({
        ...
        style: {
          brushType: "stroke",
          iconType:
            shape.style.iconType != "droplet" ? shape.style.iconType : "circle",
          x: shadowBlur + 1,
          y: shadowBlur + 1,
          n: shape.style.n,
    ...
    var devicePixelRatio =
      shape.type !== "image" ? window.devicePixelRatio || 1 : 1;
    var offset =
      (effectShape.style.width / devicePixelRatio - shape.style._width) / 2;
    ...
    var centerX =
      effectShape.style.x + effectShape.style.width / 2 / devicePixelRatio;
    var centerY =
      effectShape.style.y + effectShape.style.height / 2 / devicePixelRatio;
  ...
  function largePoint(zr, effectList, shape, zlevel) {
    ...
    var shadowColor = effect.shadowColor || color;
    var shadowBlur =
      typeof effect.shadowBlur != "undefined" ? effect.shadowBlur : size * 2;
    var devicePixelRatio = window.devicePixelRatio || 1;
  ...
  function line(zr, effectList, shape, zlevel, isLarge) {
    ...
    if (shape instanceof Polyline) {
      ...
      var duration = Math.round(
        Math.sqrt(Math.round(distance * effect.period * effect.period))
      );
...
define("echarts/component/base", [
  ...
  Base.prototype = {
    ...
    getTextStyle: function (targetStyle) {
      return zrUtil.merge(
        zrUtil.merge(targetStyle || {}, this.ecTheme.textStyle),
        ecConfig.textStyle
      );
    },
...
define("zrender/shape/util/PathProxy", [
  ...
  PathProxy.prototype.arc = function (
    cx,
    cy,
    r,
    startAngle,
...
define("echarts/component/dataView", [
  ...
  DataView.prototype = {
    ...
    show: function (newOption) {
      this._hasShow = true;
      var lang =
        this.query(this.option, "toolbox.feature.dataView.lang") || this._lang;
      this.option = newOption;
      this._tDom.innerHTML =
      ...
      if (
        this.query(this.option, "toolbox.feature.dataView.readOnly") === false
      ) {
...
define("echarts/component/axis", [
  ...
  Axis.prototype = {
    ...
    axisBase: {
      _buildAxisLine: function () {
        ...
        if (this.isHorizontal()) {
          style.yStart = style.yEnd = this.subPixelOptimize(
            style.yEnd,
            lineWidth
          );
        } else {
          style.xStart = style.xEnd = this.subPixelOptimize(
            style.xEnd,
            lineWidth
          );
        }
      ...
      refixAxisShape: function (zeroX, zeroY) {
        ...
        if (this.isHorizontal() && zeroY != null) {
          for (var i = 0, l = this.shapeList.length; i < l; i++) {
            if (this.shapeList[i]._axisShape === "axisLine") {
              this.shapeList[i].style.yStart = this.shapeList[i].style.yEnd =
                this.subPixelOptimize(zeroY, this.shapeList[i].stylelineWidth);
              this.zr.modShape(this.shapeList[i].id);
            } else if (this.shapeList[i]._axisShape === "axisTick") {
              tickLength =
                this.shapeList[i].style.yEnd - this.shapeList[i].style.yStart;
        ...
        if (!this.isHorizontal() && zeroX != null) {
          for (var i = 0, l = this.shapeList.length; i < l; i++) {
            if (this.shapeList[i]._axisShape === "axisLine") {
              this.shapeList[i].style.xStart = this.shapeList[i].style.xEnd =
                this.subPixelOptimize(zeroX, this.shapeList[i].stylelineWidth);
              this.zr.modShape(this.shapeList[i].id);
            } else if (this.shapeList[i]._axisShape === "axisTick") {
              tickLength =
                this.shapeList[i].style.xEnd - this.shapeList[i].style.xStart;
      ...
      isHorizontal: function () {
        return (
          this.option.position === "bottom" || this.option.position === "top"
        );
      },
    },
    reformOption: function (opt) {
    ...
    refresh: function (newOption) {
      ...
      var len = Math.max(
        (axisOption && axisOption.length) || 0,
      ...
      for (var i = 0; i < len; i++) {
        if (
          this._axisList[i] &&
          newOption &&
          (!axisOption[i] || this._axisList[i].type != axisOption[i].type)
        ) {
  ...
  Grid.prototype = {
    ...
    refixAxisShape: function (component) {
      ...
      while (len--) {
        axis = axisList[len];
        if (
          axis.type == ecConfig.COMPONENT_TYPE_AXIS_VALUE &&
          axis._min < 0 &&
          axis._max >= 0
        ) {
          axis.isHorizontal()
...
define("echarts/component/dataZoom", [
  ...
  DataZoom.prototype = {
    ...
    _getZoom: function () {
      ...
      var start =
        this._zoom.start != null
          ? this._zoom.start
          : this.zoomOption.start != null
          ? this.zoomOption.start
          : 0;
      var end =
        this._zoom.end != null
          ? this._zoom.end
          : this.zoomOption.end != null
          ? this.zoomOption.end
          : 100;
      if (start > end) {
        start = start + end;
    ...
    _calculScatterMap: function (seriesIndex) {
      ...
      this._zoom.scatterMap[seriesIndex] =
        this._zoom.scatterMap[seriesIndex] || {};
      var componentLibrary = require("../component");
      ...
      this._zoom.scatterMap[seriesIndex].x = vAxis
        .getAxis(axisIndex)
        .getExtremum();
      vAxis.dispose();
      ...
      this._zoom.scatterMap[seriesIndex].y = vAxis
        .getAxis(axisIndex)
        .getExtremum();
      vAxis.dispose();
    },
        ...
        if (this.zoomOption.orient == "horizontal") {
          pointList.push([
            ...
            this._location.y +
              height -
              1 -
              Math.round(((value - minValue) / valueRange) * (height - 10)),
          ]);
        } else {
          pointList.push([
            this._location.x +
              1 +
              Math.round(((value - minValue) / valueRange) * (width - 10)),
    ...
    _syncShape: function () {
      ...
      if (this.zoomOption.orient == "horizontal") {
        this._startShape.style.x =
          this._location.x + (this._zoom.start / 100) * this._location.width;
        this._endShape.style.x =
          this._location.x +
        ...
        this._fillerShae.style.width =
          this._endShape.style.x - this._startShape.style.x - this._handleSize;
      } else {
        this._startShape.style.y =
          this._location.y +
          this._location.height -
        ...
        this._fillerShae.style.height =
          this._startShape.style.y - this._endShape.style.y - this._handleSize;
      }
      this.zr.modShape(this._startShape.id);
      this.zr.modShape(this._endShape.id);
      this.zr.modShape(this._fillerShae.id);
    ...
    __ondrift: function (shape, dx, dy) {
      ...
      if (this.zoomOption.orient == "horizontal") {
        if (shape.style.x + dx - detailSize <= this._location.x) {
          ...
          shape.style.x + dx + shape.style.width + detailSize >=
        ...
        if (shape.style.y + dy - detailSize <= this._location.y) {
          ...
          shape.style.y + dy + shape.style.height + detailSize >=
    ...
    __ondragend: function () {
      if (this.zoomOption.showDetail) {
        ...
        this._startShape.style.textPosition =
          this._endShape.style.textPosition = "inside";
        this.zr.modShape(this._startShape.id);
        this.zr.modShape(this._endShape.id);
        this.zr.refreshNextFrame();
      }
    ...
    rectZoom: function (param) {
      ...
      if (
        rect.x > gridArea.x + gridArea.width ||
    ...
    getRealDataIndex: function (sIdx, dIdx) {
      ...
      if (sreies[sIdx]) {
        return (
          Math.floor((this._zoom.start / 100) * sreies[sIdx].length) + dIdx
        );
      }
      return -1;
    },
...
define("echarts/component/categoryAxis", [
  ...
  CategoryAxis.prototype = {
    ...
    _getReformedLabel: function (idx) {
      ...
      var formatter =
        this.option.data[idx].formatter || this.option.axisLabel.formatter;
      if (formatter) {
        if (typeof formatter == "function") {
          data = formatter.call(this.myChart, data);
        } else if (typeof formatter == "string") {
        ...
        if (this.isHorizontal()) {
          if (dataLength > 3) {
            ...
            while (!isEnough && interval < dataLength) {
              ...
              for (
                var i = Math.floor((dataLength - 1) / interval) * interval;
                i >= 0;
                i -= interval
              ) {
    ...
    _buildAxisTick: function () {
      ...
      if (this.isHorizontal()) {
        ...
        for (var i = startIndex; i < dataLength; i += interval) {
          ...
          x = this.subPixelOptimize(
            this.getCoordByIndex(i) + (i >= 0 ? optGap : 0),
            lineWidth
          );
          axShape = {
            _axisShape: "axisTick",
    ...
    _buildAxisLabel: function () {
      ...
      if (this.isHorizontal()) {
        ...
        for (var i = 0; i < dataLength; i += this._interval) {
          if (
            (intervalFunction && !intervalFunction(i, data[i])) ||
            this._getReformedLabel(i) === ""
          ) {
            continue;
          }
          ...
          this.shapeList.push(
            new TextShape(this._axisLabelClickable(clickable, axShape))
          );
        }
      } else {
        var xPosition;
    ...
    _buildSplitLine: function () {
      ...
      var optGap = onGap
        ...
        : 0;
      dataLength -=
        onGap || (typeof onGap == "undefined" && this.option.boundaryGap)
          ? 1
          : 0;
      if (this.isHorizontal()) {
  ...
  ValueAxis.prototype = {
        ...
        for (var i = 0; i < dataLength; i++) {
          axShape = {
            ...
            style: {
              ...
              y: yPosition,
              color:
                typeof textStyle.color === "function"
    ...
    _buildSplitArea: function () {
      ...
      if (!(color instanceof Array)) {
        ...
        if (this.isHorizontal()) {
          ...
          for (var i = 0; i <= dataLength; i++) {
            curX =
              i < dataLength ? this.getCoord(data[i]) : this.grid.getXend();
            axShape = {
              zlevel: this.getZlevelBase(),
              z: this.getZBase(),
              hoverable: false,
    ...
    _calculateValue: function () {
      if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
        ...
        var boundaryGap =
          this.option.type !== "log" ? this.option.boundaryGap : [0, 0];
    ...
    _reformTimeValue: function () {
      var splitNumber =
        this.option.splitNumber != null ? this.option.splitNumber : 5;
    ...
    _customerValue: function () {
      ...
      for (var i = 0; i <= splitNumber; i++) {
        this._valueList.push(
          accMath.accAdd(this._min, accMath.accMul(splitGap, i))
        );
      }
      this._reformLabelData();
    },
    ...
    getExtremum: function () {
      ...
      return {
        ...
        dataMappingMethods: dataMappingMethods
          ? zrUtil.merge({}, dataMappingMethods)
          : null,
      };
    },
    ...
    getCoordSize: function (value) {
      if (!this.isHorizontal()) {
        return Math.abs(
          (value / (this._max - this._min)) * this.grid.getHeight()
        );
      } else {
        return Math.abs(
          (value / (this._max - this._min)) * this.grid.getWidth()
        );
      }
    },
    getValueFromCoord: function (coord) {
      ...
      if (!this.isHorizontal()) {
        ...
        result =
          this._max -
          ((coord - this.grid.getY()) / this.grid.getHeight()) *
            (this._max - this._min);
      } else {
        ...
        result =
          this._min +
          ((coord - this.grid.getX()) / this.grid.getWidth()) *
            (this._max - this._min);
      }
      if (this._dataMappingMethods) {
...
define("echarts/util/date", [], function () {
  ...
  function getAutoFormatter(min, max, splitNumber) {
    ...
    for (var i = 0, l = _timeGap.length; i < l; i++) {
      ...
      totalGap =
        Math.ceil(max / curValue) * curValue -
...
define("echarts/util/smartLogSteps", ["require", "./number"], function (
  require
) {
  ...
  function makeTicksList() {
    ...
    function baseAnalysis() {
      ...
      for (
        var n = minExponAdjust;
        n - stepExpon <= maxDataLog;
        n += stepExpon
      ) {
    ...
    if (logLabelMode === "exponent") {
      ...
      return function (value) {
        ...
        return (
          sign +
          myLogLabelBase +
          makeSuperscriptExponent(mathLog(value) / myLnBase)
        );
      };
    } else {
      return function (value) {
