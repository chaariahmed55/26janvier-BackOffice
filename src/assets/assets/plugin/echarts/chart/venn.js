...
define(function (require) {
  ...
  Venn.prototype = {
    ...
    _buildVenn: function (seriesIndex) {
      ...
      var coincideLengthAnchor =
        (((r0 + r1) / 2) * Math.sqrt(data[2].value)) /
        Math.sqrt((data[0].value + data[1].value) / 2);
      ...
      if (
        ...
        var xLeft =
          (r0 * r0 - r1 * r1) / (2 * coincideLength) + coincideLength / 2;
        var xRight =
          coincideLength / 2 - (r0 * r0 - r1 * r1) / (2 * coincideLength);
    ...
    _getCoincideLength: function (
      ...
      // 计算
      var x =
        (r0 * r0 - r1 * r1) / (2 * coincideLengthAnchor) +
        coincideLengthAnchor / 2;
      var y =
        coincideLengthAnchor / 2 -
        (r0 * r0 - r1 * r1) / (2 * coincideLengthAnchor);
      // 夹角
      ...
      // 若是公共面积比较小，使距离减小一些，让公共面积增大
        ...
        // 二分法计算新的步调
        coincideLengthAnchor =
          (coincideLengthAnchor + coincideLengthAnchorMin) / 2;
      ...
      // 若是公共面积比较大，使距离增大一些，让公共面积减小
        ...
        coincideLengthAnchor =
          (coincideLengthAnchor + coincideLengthAnchorMax) / 2;
        return this._getCoincideLength(
          value0,
          value1,
          value2,
