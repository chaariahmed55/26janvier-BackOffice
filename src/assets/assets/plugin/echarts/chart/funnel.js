...
define(function (require) {
  ...
  Funnel.prototype = {
    ...
    _buildSingleFunnel: function (seriesIndex) {
      ...
      var height =
        total > 1
          ? (location.height - (total - 1) * gap) / total
          : location.height;
      var width;
    ...
    _mapData: function (seriesIndex) {
      ...
      if (serie.sort != "none") {
        funnelData.sort(
          serie.sort === "descending" ? numDescending : numAscending
        );
      }
    ...
    getLabel: function (
      ...
      if (
        ...
        textAlign = align;
        textColor =
          Math.max(topWidth, bottomWidth) / 2 >
          zrArea.getTextWidth(text, textFont)
            ? "#fff"
            : zrColor.reverse(defaultColor);
    ...
    getLabelLine: function (
      ...
      var lineShape = {
        ...
        hoverable: false,
        style: {
          xStart: this._getLabelLineStartPoint(
            x,
            location,
            topWidth,
            bottomWidth,
    ...
    _getLabelPoint: function (
      ...
      position =
        position === "inner" || position === "inside" ? "center" : position;
      switch (position) {
        case "center":
          return align == "center"
            ? x + topWidth / 2
    ...
    _getLabelLineStartPoint: function (
      x,
      location,
      topWidth,
      bottomWidth,
