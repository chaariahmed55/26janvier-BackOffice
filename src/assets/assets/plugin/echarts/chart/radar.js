  ...
  Radar.prototype = {
    ...
    _addDataShape: function (
      ...
      var shape = {
        ...
        highlightStyle: {
          brushType:
            this.deepQuery(queryTarget, "itemStyle.emphasis.areaStyle") ||
            nIsAreaFill
              ? "both"
              : "stroke",
          color:
          ...
          strokeColor:
            ...
            defaultColor,
          lineWidth:
            this.deepQuery(queryTarget, "itemStyle.emphasis.lineStyle.width") ||
            nLineWidth,
          lineType:
            this.deepQuery(queryTarget, "itemStyle.emphasis.lineStyle.type") ||
            nLineType,
        },
      };
      ecData.pack(
    ...
    ondragend: function (param, status) {
      ...
      this.component.legend &&
        this.component.legend.del(series[seriesIndex].data[dataIndex].name);
