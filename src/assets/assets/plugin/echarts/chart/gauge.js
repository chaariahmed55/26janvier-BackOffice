...
define(function (require) {
  ...
  Gauge.prototype = {
    ...
    _buildSingleGauge: function (seriesIndex) {
      ...
      this._paramsMap[seriesIndex].totalAngle =
        this._paramsMap[seriesIndex].startAngle -
    ...
    _buildAxisLabel: function (seriesIndex) {
      ...
      for (var i = 0; i <= splitNumber; i++) {
        value = accMath.accAdd(
          min,
          accMath.accMul(accMath.accDiv(total, splitNumber), i)
        );
        angle = startAngle - (totalAngle / splitNumber) * i;
        ...
        this.shapeList.push(
          new TextShape({
            ...
            style: {
              ...
              color:
                color === "auto" ? this._getColor(seriesIndex, value) : color,
    ...
    _buildPointer: function (seriesIndex) {
      ...
      var angle =
        ((params.startAngle -
          (params.totalAngle / total) * (value - serie.min)) *
          Math.PI) /
        180;
      var color =
        pointer.color === "auto"
      ...
      ecData.pack(
        ...
        seriesIndex,
        this.series[seriesIndex].data[0],
        0,
        ...
        this.shapeList.push(
          new TextShape({
            ...
            style: {
              ...
              y: y,
              color:
                textColor === "auto" ? this._getColor(seriesIndex) : textColor,
              text: name,
              textAlign: "center",
    ...
    _buildDetail: function (seriesIndex) {
      ...
      var x =
        ...
        this.parsePercent(offsetCenter[0], params.radius[1]);
      var y =
        params.center[1] + this.parsePercent(offsetCenter[1], params.radius[1]);
      this.shapeList.push(
        new RectangleShape({
          zlevel: serie.zlevel,
          z:
