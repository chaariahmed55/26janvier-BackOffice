    ...
    if ("function" != typeof i.onWarn) {
      var k = i.countdownMessage
        ...
        l = i.countdownBar
          ...
          : "";
      a("body").append(
        '<div class="modal fade" id="session-timeout-dialog"><div class="modal-dialog modal-dialog-centered"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">' +
          i.title +
