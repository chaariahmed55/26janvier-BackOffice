!(function () {
  ...
  (window.MaterialSelectfield = s),
    ...
    (s.prototype.checkDisabled = function () {
      this.select_.disabled
        ? this.element_.classList.add(this.CssClasses_.IS_DISABLED)
        : this.element_.classList.remove(this.CssClasses_.IS_DISABLED);
    }),
    (s.prototype.checkDisabled = s.prototype.checkDisabled),
    (s.prototype.checkValidity = function () {
      this.select_.validity.valid
        ? this.element_.classList.remove(this.CssClasses_.IS_INVALID)
        : this.element_.classList.add(this.CssClasses_.IS_INVALID);
    }),
    (s.prototype.checkValidity = s.prototype.checkValidity),
    (s.prototype.checkDirty = function () {
      this.select_.value && this.select_.value.length > 0
        ? this.element_.classList.add(this.CssClasses_.IS_DIRTY)
        : this.element_.classList.remove(this.CssClasses_.IS_DIRTY);
    }),
    (s.prototype.checkDirty = s.prototype.checkDirty),
    ...
    (s.prototype.change = function (s) {
      s && (this.select_.value = s), this.updateClasses_();
    }),
    (s.prototype.change = s.prototype.change),
    (s.prototype.init = function () {
      if (
        ...
        (this.select_ = this.element_.querySelector(
          "." + this.CssClasses_.SELECT
        )),
        this.select_)
      ) {
    ...
    (s.prototype.mdlDowngrade_ = function () {
      this.select_.removeEventListener(
        "change",
        this.boundUpdateClassesHandler
      ),
